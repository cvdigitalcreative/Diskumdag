...
class M_tulisan extends CI_Model{
	...
	function simpan_tulisan($judul,$isi,$kategori_id,$kategori_nama,$album_id,$album_nama,$user_id,$user_nama,$gambar,$slug,$keterangan){
		$hsl=$this->db->query("INSERT into tbl_tulisan(tulisan_judul,tulisan_isi,tulisan_kategori_id,tulisan_kategori_nama,tulisan_album_id,tulisan_album_nama,tulisan_pengguna_id,tulisan_author,tulisan_gambar,tulisan_slug,tulisan_keterangan) values ('$judul','$isi','$kategori_id','$kategori_nama','$album_id','$album_nama','$user_id','$user_nama','$gambar','$slug','$keterangan')");
		return $hsl;
	}
	function simpan_tulisan_tanpa_gambar($judul,$isi,$kategori_id,$kategori_nama,$album_id,$album_nama,$user_id,$user_nama,$slug,$keterangan){
		$hsl=$this->db->query("INSERT into tbl_tulisan(tulisan_judul,tulisan_isi,tulisan_kategori_id,tulisan_kategori_nama,tulisan_album_id,tulisan_album_nama,tulisan_pengguna_id,tulisan_author,tulisan_slug,tulisan_keterangan) values ('$judul','$isi','$kategori_id','$kategori_nama','$album_id','$album_nama','$user_id','$user_nama',$slug','$keterangan')");
		return $hsl;
	}
	...
	function update_tulisan($tulisan_id,$judul,$isi,$kategori_id,$kategori_nama,$album_id,$album_nama,$user_id,$user_nama,$gambar,$slug,$keterangan){
		$hsl=$this->db->query("UPDATE tbl_tulisan set tulisan_judul='$judul',tulisan_isi='$isi',tulisan_kategori_id='$kategori_id',tulisan_kategori_nama='$kategori_nama',tulisan_album_id='$album_id',tulisan_album_nama='$album_nama',tulisan_pengguna_id='$user_id',tulisan_author='$user_nama',tulisan_gambar='$gambar',tulisan_slug='$slug',tulisan_keterangan='$keterangan' where tulisan_id='$tulisan_id'");
		return $hsl;
	}
	function update_tulisan_tanpa_img($tulisan_id,$judul,$isi,$kategori_id,$kategori_nama,$album_id,$album_nama,$user_id,$user_nama,$slug,$keterangan){
		$hsl=$this->db->query("UPDATE tbl_tulisan set tulisan_judul='$judul',tulisan_isi='$isi',tulisan_kategori_id='$kategori_id',tulisan_kategori_nama='$kategori_nama',tulisan_album_id='$album_id',tulisan_album_nama='$album_nama',tulisan_pengguna_id='$user_id',tulisan_author='$user_nama',tulisan_slug='$slug',tulisan_keterangan='$keterangan' where tulisan_id='$tulisan_id'");
		return $hsl;
	}
	...
	function balas($id,$pesan,$balas){
		$hsl=$this->db->query("INSERT into tbl_inbox_reply(inbox_id,inbox_pesan,inbox_reply) VALUES ('$id','$pesan','$balas') ");
		return $hsl;
	}
 
	function status($id){
		$hsl=$this->db->query("UPDATE tbl_inbox SET status='success' WHERE inbox_id='$id'");
		return;
	}
	...
	function get_tulisan_by_kategori($kategori_id){
		$hsl=$this->db->query("SELECT tbl_tulisan.*,DATE_FORMAT(tulisan_tanggal,'%d/%m/%Y') AS tanggal FROM tbl_tulisan where tulisan_kategori_id='$kategori_id' ORDER BY tulisan_tanggal DESC  ");
		return $hsl;
	}

	function get_tulisan_by_kategoris($kategori_id){
		$hsl=$this->db->query("SELECT tbl_tulisan.*,DATE_FORMAT(tulisan_tanggal,'%d/%m/%Y') AS tanggal FROM tbl_tulisan where tulisan_kategori_id='$kategori_id' ORDER BY tulisan_id ASC  ");
		return $hsl;
	}

        function get_tulisan_by_kategori_berita($kategori1,$kategori2){
		$hsl=$this->db->query("SELECT tbl_tulisan.*,DATE_FORMAT(tulisan_tanggal,'%d/%m/%Y') AS tanggal FROM tbl_tulisan where tulisan_kategori_id > 13 and tulisan_kategori_id < 16 ORDER BY tulisan_tanggal DESC LIMIT 6");
		return $hsl;
	}

	function get_tulisan_by_kategori_limit($kategori_id,$limit){
		$hsl=$this->db->query("SELECT tbl_tulisan.*,DATE_FORMAT(tulisan_tanggal,'%d/%m/%Y') AS tanggal FROM tbl_tulisan where tulisan_kategori_id='$kategori_id' limit $limit");
		return $hsl;
	}
