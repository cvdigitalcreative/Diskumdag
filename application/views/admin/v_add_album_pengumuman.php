      ...
      <div class="row">
        <div class="col-xl-8 mb-30">
            <div class="card card-statistics h-100"> 
                <div class="card-body">
                  <form  action="<?php echo base_url().'Admin/Album_pengumuman/simpan_tulisan'?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                      <div class="form-group">
                          <label class="control-label" for="fname">Judul</label>
                          <div class="mb-4">
                            <input type="text" class="form-control" id="fname" name="xjudul" placeholder="First name"/>
                          </div>
                ...
                <div class="card-body">
                  <div class="form-group">
                      ...
                      <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="xkategori">
                          ...
                          ?>
                            <option value="<?php echo $tulisan_id?>"><?php echo $row['tulisan_judul']."<br/>" ?></option>
                          <?php endforeach; ?>
