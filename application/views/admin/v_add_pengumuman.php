      ...
      <div class="row">
        <div class="col-xl-8 mb-30">
            <div class="card card-statistics h-100"> 
                <div class="card-body">
                  <form  action="<?php echo base_url().'Admin/Pengumuman/simpan_tulisan'?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                      <div class="form-group">
                          ...
                          <label class="control-label" for="fname">News Content</label>
                            <textarea id="summernote" name="xisi" required/>Content Web</textarea>
                      </div>
                  </div>
              </div>  
          </div>
