          ...
          <div class="card card-statistics h-100"> 
            <div class="card-body">
              <div class="col-xl-12 mb-10">
                  <a href="<?php echo base_url()?>Admin/Album_pengumuman/add_tulisan" class="btn btn-primary btn-block ripple m-t-20">
                ...
                <tbody>
                  <?php
                    ...
                    foreach ($data->result_array() as $i) :
                       $no++;
                        $album_id = $i['album_id'];
                        $album_tanggal = $i['album_tanggal'];
                        $album_nama = $i['album_nama'];
                        $album_gambar = $i['album_gambar'];
                        $author=$i['author'];
                   
                    ?>
                
                <tr>
                    <td><img src="<?php echo base_url().'assets/images/'.$album_gambar;?>" style="width:90px;"></td>
                    <td><?php echo $album_nama;?></td>  
                    <td><?php echo $album_tanggal ?></td>               
                    <td><?php echo $author;?></td>
                    <td>
                         <a href="<?php echo base_url().'Admin/Album_pengumuman/get_edit/'.$album_id;?>" style="margin-right: 20px" ><span class="ti-pencil"></span></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body p-20">
                        <form action="<?php echo base_url().'Admin/Album_pengumuman/hapus_tulisan'?>" method="post">
                            <div class="row">
                                <div class="col-md-12">
                                    <input type="hidden" name="kode" value="<?php echo $album_id;?>"/> 
                                    <p>Apakah kamu yakin ingin menghapus album ini <b><i><?php echo $album_nama;?></i></b></p>
                                </div>
                            </div>
