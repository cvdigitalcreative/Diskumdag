      ...
      <div class="row">
        <div class="col-xl-8 mb-30">
            <div class="card card-statistics h-100"> 
                <div class="card-body">
                  <form  action="<?php echo base_url().'Admin/Album_pengumuman/update_tulisan'?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                      <div class="form-group">
                          <label class="control-label" for="fname">Judul</label>
                          <div class="mb-4">
                            <input type="hidden" name="kode" value="<?php echo $b['album_id'];?>">
                            <input type="text" class="form-control" id="fname" name="xjudul" placeholder="First name" value="<?php echo $b['album_nama'];?>" >
                          </div>
        ...
        <div class="col-xl-4 mb-30">
            <div class="card card-statistics h-51"> 
                <div class="card-body">
                   <div class="form-group">
                      <label class="mr-sm-2" for="inlineFormCustomSelect">Kategori Album Pengumuman</label>
                      <select class="custom-select mr-sm-2" id="inlineFormCustomSelect" name="xkategori">
                          <option selected value="<?php echo $b['album_kategori_id'] ?>"><?php echo $b['album_nama'] ?></option>
                          <?php foreach($kat->result_array() as $row): ?>
                            <option value="<?php echo $row['tulisan_id'];?>"><?php echo $row['tulisan_judul'];?></option>
                          <?php endforeach; ?>  
                      </select>
                  </div> 
                  <div class="form-group">
